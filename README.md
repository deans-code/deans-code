...
| :crystal_ball: Artifcial Intelligence | [LLama.cpp](https://github.com/deans-code/lama.cpp) | Running language models locally using [Llama.cpp](https://github.com/ggml-org/llama.cpp). |
